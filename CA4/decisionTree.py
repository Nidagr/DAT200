# -*- coding: utf-8 -*-
"""
Created on Fri Mar 26 13:21:52 2021

@author: Nida

CA4: Decision tree classifier
"""
import pandas as pd
...
DTC_pipe = make_pipeline(DecisionTreeClassifier(random_state=1))
...
print('CV accuracy for iterative imputed: %.3f +/- %.3f' % (np.mean(scores_3),
                                                            np.std(scores_3)))
"""
CV accuracy for drop_na: 0.858 +/- 0.013
CV accuracy for knn imputed: 0.846 +/- 0.018
CV accuracy for iterative imputed: 0.866 +/- 0.020
"""